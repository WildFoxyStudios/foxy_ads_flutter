...
class AppTheme {
  ...
  static ThemeData get darkTheme {
    const darkScaffoldBg = Color(0xFF0F172A); // Rich dark slate
    const darkSurface = Color(0xFF1E293B); // Elevated container / card
    const darkSurfaceContainer = Color(0xFF263345);
